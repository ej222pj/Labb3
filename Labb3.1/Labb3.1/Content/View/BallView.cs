...
namespace Labb3._1.Content.View
{
    class BallView
    {
        ...
        {
            int vx = (int)(ball.getXPos() * camera.Scale + camera.getFrame());
            int vy = (int)(ball.getYPos() * camera.Scale + camera.getFrame());
            int ballSize = (int)(ball.getDiameter() * camera.Scale);
